<html>
  <head>
    ...
    <?php echo Html::script('asteroides/jquery-1.4.1.min.js'); ?>    
    <?php echo Html::script('asteroides/vector_battle_regular.typeface.js'); ?>    
    <?php echo Html::script('asteroides/ipad.js'); ?>    
    <?php echo Html::script('asteroides/game.js'); ?>  
